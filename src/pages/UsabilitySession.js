  ...
  return (
    <div className="page-wrap">
      ...
      <p>
        ...
        research—reassuring participants that their honesty, whether positive or
        negative, would help us craft better solutions.
      </p>
      <p>
        ...
        performed daily. This hands-on approach allowed me to observe real-time
        pain points, which were often reinforced by their commentary.
      </p>
      ...
      <p>
        ...
        collaborative space allowed me to work closely with my team, identifying
        "quick wins" that the development team could implement to deliver
        immediate improvements.
      </p>

      <h2>Conclusion</h2>
      <p>
        Overall, the research provided valuable insights into user frustrations
        and areas for improvement, shaping future design and development
        priorities. It was a productive exercise in addressing real user needs
        and refining the VIEW platform.
      </p>
    </div>
  );
};
