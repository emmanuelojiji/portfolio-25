...
const WarehouseReporting = () => {
  return (
    <div className="page-wrap">
      <h1>Warehouse Employee Performance Reporter</h1>
      ...
      <p>
        ...
        insights into performance on an hourly and even minute-by-minute basis.
      </p>
      <p>
        Recognizing the inefficiencies in this approach, I proposed building an
        in-house performance tracking system that would automate data collection
        and provide the granularity they needed. This solution would streamline
        the tracking process, making it easier for warehouse managers to monitor
        performance in real time and respond to productivity trends more
        effectively.
      </p>

      <h2>Introduction</h2>
      <p>
        This case study outlines the strategy developed to enhance the warehouse
        team’s ability to track employee productivity with precision and
        reliability. The goal was to transition from manual processes to an
        automated system that delivers actionable insights, enabling warehouse
        managers to make timely and informed decisions.
      </p>

      <h2>Research and Discovery</h2>
      <p>
        To understand the challenges faced by the warehouse team, I conducted a
        series of interviews with managers and shadowed their workflow to
      ...
      <ul>
        ...
        <li>
          ...
          provided daily performance data, which limited the ability to identify
          productivity trends during specific hours.
        </li>
        <li>
      ...
      <ul>
        <li>
          <strong>Automated Data Collection:</strong> Replace manual entry with
      ...
      <p>
        ...
        involved backend developers to ensure seamless integration with existing
        systems and data pipelines. Regular check-ins ensured alignment with
      ...
      <ul>
        <li>
          <strong>Automated Reporting:</strong> Replacing manual data entry with
          backend integration to reduce errors and save time.
        </li>
        <li>
        ...
        <li>
          <strong>User-Friendly Interface:</strong> Designing a clean layout for
      ...
      <ul>
        <li>
          <strong>Error Reduction:</strong> Eliminated manual data entry errors,
          saving an estimated 10 hours weekly.
        </li>
        <li>
          <strong>Real-Time Insights:</strong> Enabled managers to identify and
          address productivity dips as they occurred.
        </li>
        <li>
          <strong>Enhanced Efficiency:</strong> Streamlined workflows, allowing
      ...
      <p>
        Future enhancements include the development of Employee Profiles, which
        will store detailed performance metrics, averages, and personalized
        reports. Additionally, predictive analytics could be introduced to
        forecast productivity trends and proactively address potential issues.
      </p>
    </div>
  );
};
